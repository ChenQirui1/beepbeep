...
const sketch = (s) => {
  ...
  s.draw = () => {
    ...
    // Set up camera view
    s.camera(0, -100, 300, 0, 0, 0, 0, 1, 0);

    // Add lighting for 3D effect
    s.ambientLight(100);
    s.directionalLight(255, 255, 255, 0, -1, -0.5);
  ...
  class Robot {
    ...
    render(x, y, z) {
      s.push();
      s.translate(x, y, z);
      s.rotateY(this.currentRotation);
